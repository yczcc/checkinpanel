...
<a href="https://github.com/yczcc/checkinpanel/stargazers"><img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/yczcc/checkinpanel?color=yellow&logo=riseup&logoColor=yellow&style=flat-square"></a>
<a href="https://github.com/yczcc/checkinpanel/network/members"><img alt="GitHub forks" src="https://img.shields.io/github/forks/yczcc/checkinpanel?color=orange&style=flat-square"></a>
<a href="https://github.com/yczcc/checkinpanel/issues"><img alt="GitHub issues" src="https://img.shields.io/github/issues/yczcc/checkinpanel?color=red&style=flat-square"></a>
...
<a href="https://github.com/yczcc/checkinpanel/search?l=python"><img alt="GitHub code size in bytes" src="https://img.shields.io/github/languages/code-size/yczcc/checkinpanel?color=blueviolet&logo=visual%20studio%20code&logoColor=informational&style=flat-square"></a>
...
<a href="https://scrutinizer-ci.com/g/yczcc/checkinpanel/?branch=master"><img alt="Scrutinizer code quality (GitHub/Bitbucket)" src="https://img.shields.io/scrutinizer/quality/g/yczcc/checkinpanel?logo=Scrutinizer&style=flat-square"></a>
<a href="https://github.com/yczcc/checkinpanel/commits"><img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/yczcc/checkinpanel?color=success&logo=github&style=flat-square"/></a>
</div>
...
```text
https://raw.githubusercontent.com/yczcc/checkinpanel/master/dailycheckin.json
```

### 2. 抓包配置

下载 [check.sample.toml](https://raw.githubusercontent.com/yczcc/checkinpanel/master/check.sample.toml)，根据注释说明进行抓包并配置
...
下载项目中的[推送配置文件](https://github.com/yczcc/checkinpanel/blob/master/notify.sample.toml)到**配置文件夹**，按照上述说明修改配置文件中的值并改名为 `notify.toml` ，你可以**自由地删除**该文件中某些不需要的值（注意语法）。
...
本通知调用了项目中的 [𝒏𝒐𝒕𝒊𝒇𝒚_𝒎𝒕𝒓.𝒑𝒚](https://raw.githubusercontent.com/yczcc/checkinpanel/master/notify_mtr.py) 。如果你想在**你自己的项目中**使用这个通知脚本，将它拷贝并调用对应的通知函数即可。

在非容器环境中，通知环境变量使用 系统的环境变量 或者 **你通过 `NOTIFY_CONFIG_PATH` 环境变量指定的配置文件** 进行配置。

特别的，如果你想要创建一个基于 python 的 elecV2P 或者 qinglong 项目，并有意愿使用 `toml` 文件，那么强烈建议你拷贝[此文件](https://raw.githubusercontent.com/yczcc/checkinpanel/master/notify_mtr.py)，如此可以大幅度降低用户脚本的配置难度和升级难度。

如果只希望使用 `json` 模块和单纯获取环境变量方法，那么可以拷贝 [𝒏𝒐𝒕𝒊𝒇𝒚_𝒎𝒕𝒓_𝒆𝒏𝒗.𝒑𝒚](https://raw.githubusercontent.com/yczcc/checkinpanel/master/notify_mtr_env.py)。
...
* 如果任务列表安装不成功，参考 [#12](https://github.com/yczcc/checkinpanel/issues/12)
...
```sh
ql repo https://github.com/yczcc/checkinpanel.git "api_|ck_|ins_" "^checkin" "^notify|^utils|cpm" "master"
```
...
* **运行 `签到依赖` 任务**
  ...
  * [截图](https://github.com/yczcc/checkinpanel/issues/43)
...
参见上文中的[配置通知](#https://github.com/yczcc/checkinpanel/blob/master/README.md#4配置通知)
...
根据[注释说明](https://github.com/yczcc/checkinpanel/blob/master/check.sample.toml)进行抓包并配置
...
3. 大部分脚本移植于 [Sitoi](https://github.com/Sitoi/dailycheckin)，Sitoi 于 2021 年 9 月 3 日 [dailycheckin-0.1.7](https://files.pythonhosted.org/packages/ee/8d/b49624a4d11c51f4e3dfb98f622d0c1ffe5d6315ad39452859ea8703206f/dailycheckin-0.1.7.tar.gz)  版本适配了青龙，[使用教程](https://sitoi.gitee.io/dailycheckin/qinglong/)与本仓库教程不相同，切勿使用本仓库 [checkinpanel](https://github.com/yczcc/checkinpanel) 的同时去问大佬。

4. 2021 年 9 月 13 日起不再更新 `.json` 后缀的配置文件。

5. 2021 年 9 月 23 日起重新初始化项目，原本文件移到[这里](https://github.com/yczcc/ck_bak)，上述仓库不再进行更新，期望稳定的用户可以切换到上述仓库。
...
[![Stargazers over time](https://starchart.cc/yczcc/checkinpanel.svg)](https://starchart.cc/yczcc/checkinpanel)
