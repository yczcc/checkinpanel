...
class IMaoTai:
    ...
    # 获取小茅运用户耐力值奖励
    def getXmyUserEnergyAward(self) -> dict:
        resMsg = {"name": " * 小茅运每日申购奖励", "value": ''}
        resMsgValue = '\n\t'
        """
        领取耐力
        """
